...
namespace DataAccessLayer
{
    ...
    public partial class PharmacyManagementEntities : DbContext
    {
        ...
        public virtual int AddUser(string empname, string address, string email, string phone, string gender, string age, string role, string username, string password)
        {
            var empnameParameter = empname != null ?
                new ObjectParameter("empname", empname) :
                new ObjectParameter("empname", typeof(string));
        ...
        public virtual int EmployeeDetailDisplay()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("EmployeeDetailDisplay");
        }
